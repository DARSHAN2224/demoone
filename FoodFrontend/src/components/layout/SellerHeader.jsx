...
const SellerHeader = () => {
  ...
  const navigation = [
    ...
    { name: 'Drone Coordination', href: '/seller/drone-coordination', icon: Drone },
    { name: 'Drone Tracking', href: '/seller/drone-tracking', icon: Drone },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link to="/seller" className="flex items-center space-x-3">
